...
[Translation Process](https://github.com/clowncrew/jokecoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the JokeCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Jokecoin
...
Where a patch set proposes to change the Jokecoin consensus, it must have been
...
The review process is normally fairly responsive on the JokeCoin Core repository, however
