...
void BitcoinGUI::createActions()
{
    ...
    privateSendCoinsAction->setStatusTip(tr("PrivateSend coins to a Jokecoin address"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Jokecoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the jokecoin logo
