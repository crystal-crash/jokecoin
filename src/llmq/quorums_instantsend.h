// Copyright (c) 2019-2020 The Jokecoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef JOKECOIN_QUORUMS_INSTANTSEND_H
#define JOKECOIN_QUORUMS_INSTANTSEND_H
...
#endif//JOKECOIN_QUORUMS_INSTANTSEND_H
