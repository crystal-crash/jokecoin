...
"""Verify that starting jokecoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jokecoind with -h for help text")
        ...
        self.log.info("Start jokecoind with -version for version information")
