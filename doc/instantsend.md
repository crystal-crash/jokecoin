...
This mechanism has been integrated into Bitcore-Node-Jokecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/clowncrew/insight-api-jokecoin#web-socket-api](https://github.com/clowncrew/insight-api-jokecoin#web-socket-api)
* API: [https://github.com/clowncrew/insight-api-jokecoin#instantsend-transactions](https://github.com/clowncrew/insight-api-jokecoin#instantsend-transactions)
