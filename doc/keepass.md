...
The following new options are available for jokecoind and jokecoin-qt:
...
The following rpc commands are available:
 ...
 - _keepass init_: sets up the association between jokecoind and keepass by generating an AES key and sending an association message to KeePassHttp. This will trigger KeePass to ask for an Id for the association. Returns the association and the base64 encoded string for the AES key.
...
Sample initialization flow from _jokecoin-qt_ console (this needs to be done only once to set up the association):
 ...
 - You should get a response like this "_Association successful. Id: mydrkwalletjokecoin - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _jokecoin.conf_ and fill in these values
```
keepass=1
