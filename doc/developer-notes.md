...
Jokecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
([`valgrind.supp`](https://github.com/clowncrew/jokecoin/blob/master/contrib/valgrind.supp))
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Jokecoin Core, the wallet was always
