...
official/supported Docker Images found at https://hub.docker.com/r/clowncrew/jokecoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/clowncrew/jokecoind-develop/ when changing the above text**